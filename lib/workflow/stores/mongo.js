...
function mongoStoreFactory(waterline, Promise, Constants, Errors, assert, _) {
    ...
    */
    ...
    exports.findReadyTimers = function(limit) {
        var query = {
            $or: [ {nextScheduled: {$lte: new Date()}}, {nextScheduled: null}],
            paused: false
        }
        var options = {
        ...
        return waterline.workitems.findMongo(query, options);
    };
    ...
    exports.updateTimerNext = function(timer, next) {
        var query = {
            _id: waterline.workitems.mongo.objectId(timer._id)
        };
    ...
    exports.updateTimerStatus = function(id, status, nextScheduled, endDate) {
        var query = {
